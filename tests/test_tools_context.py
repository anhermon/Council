...
from council.tools.context import validate_file_path, validate_include_pattern, check_xml_security
...
class TestValidateFilePath:
    ...
    def test_path_outside_project(self, mock_settings, tmp_path):
